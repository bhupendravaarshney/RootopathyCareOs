...
SELECT permission_key,
       ...
       permission_key = ANY (ARRAY[
           'workforce.person.restricted_read','credential.document.read','credential.review.decide',
       ...
       WHEN permission_key = ANY (ARRAY[
           'credential.review.decide','credential.registration.lifecycle','credential.lifecycle',
       ...
       permission_key = ANY (ARRAY[
           'credential.review.decide','credential.registration.lifecycle','credential.lifecycle',
           'practitioner.scope.approve','practitioner.scope.lifecycle','workforce.activation.approve',
           'workforce.activation.execute','workforce.lifecycle.suspend','workforce.lifecycle.reactivate',
           'workforce.offboarding.approve','workforce.offboarding.execute','workforce.export.request',
           'workforce.export.approve','workforce.export.access','workforce.registry.approve',
           'workforce.registry.activate'
       ])
