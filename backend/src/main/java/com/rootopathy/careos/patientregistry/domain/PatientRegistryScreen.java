package com.rootopathy.careos.patientregistry.domain;
...
/**
 * Minimum-necessary, server-authorized projection used by the sixteen Module 3 screens.
 * Patient data, lifecycle truth and action availability are projected by the server.
 */
public record PatientRegistryScreen(
        UUID organizationId,
        String screenId,
        String title,
        String purpose,
